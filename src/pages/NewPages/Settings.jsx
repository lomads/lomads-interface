...
const Settings = () => {
  ...
  const { DAO, updateDaoLoading, updateDaoLinksLoading } = useAppSelector(
      ...
      <div className="settings-page">
            ...
            {_get(DAO, "image", null) ? (
              ...
              <p style={{ textTransform: "capitalize" }}>
                {daoName.length === 1
                  ? daoName[0].charAt(0)
                  : daoName[0].charAt(0) +
                    daoName[daoName.length - 1].charAt(0)}
              </p>
            )}
          </div>
        ...
        <div className="settings-center">
          <div>
            ...
            <div
              className="settings-organisation"
              onClick={() => {
            ...
            >
              <div>
                ...
                <Link className="style-content" style={{ color: "#C94B32" }}>
            ...
            <div className="settings-organisation-flexbox">
              ...
              <div
                className="settings-organisation-child disabled"
                onClick={() => {
                  setOpenDiscord(true);
                }}
              >
