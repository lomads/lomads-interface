				...
				<div className="SideModalRolesPermissions">
					...
					<div className="MainComponent-rolesPermissions">
						<div className="test">
							...
							<div id="rp-text">
								Default member roles and permissions are set and ready, based on industry best practices. Customization options coming soon!
							</div>
						</div>
								...
								<table borderless>
									<thead>
										<tr>
											<th></th>
											<th>Admin</th>
											<th>Core Contributor</th>
											<th>Active Contributor</th>
											<th>Contributor</th>
										</tr>
									</thead>
									<tbody>
										<tbody class="labels">
											<tr>
												<td colspan="5">
													<label for="accounting">Organisation Settings</label>
										...
										<tbody class="hide">
											<tr>
												<td>Edit Organisation Settings</td>
												<td><Image
													style={{ width: "30px", height: "30px" }}
													src={TotalAccess}
													alt="total access icon"
