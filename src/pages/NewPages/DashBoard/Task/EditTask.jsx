...
const EditTask = ({ close, task, daoURL }) => {
    ...
    const handleEditTask = () => {
        if (name === '') {
            ...
            if (!symbol)
                symbol = currency.currency === process.env.REACT_APP_MATIC_TOKEN_ADDRESS ||  currency === process.env.REACT_APP_GOERLI_TOKEN_ADDRESS ? chainId === SupportedChainId.GOERLI ? 'GOR' : 'MATIC' : ''
