...
const Dashboard = () => {
  ...
  const governorAddress = useAppSelector(
    (state) => state.proposal.deployedGovernorAddress
  );
  ...
  return (
    <>
      ...
      >
        <div className={"pageTitle"}>Dashboard Page</div>
        <div className={"pageDescription"} style={{ width: "486px" }}>
          You can mint, and send ERC20 tokens here
        </div>
        <div>
          <div className={"gotitle"}>Contracts Deployed Address</div>
          ...
          <div className={"gotitle"}>Token Transaction</div>
          <div>
            <MintTokenComponent />
          </div>
          <div>
        ...
        <div>
          <div className={"gotitle"}>Deployed DAO Info from Moralis</div>
          <div className={"tileItemHeader"} style={{ paddingTop: 0 }}>
            DAO title : {title}
          </div>
          <div className={"tileItemHeader"} style={{ paddingTop: 0 }}>
