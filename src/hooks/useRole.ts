...
const CONTRIBUTOR: Array<string> = ['project.view', 'project.view.own'];
...
const CORE_CONTRIBUTOR: Array<string> = [...ACTIVE_CONTRIBUTOR, 'project.view.all', 'transaction.view', 'members.view', 'members.add']
